...
def song(_, message):
    ...
    try:
        ...
        rep = f"**🎧 Yükləndi @BrendTaggerBot tərəfindən**"
...
@Client.on_message(
    command(["vdasasfsong", f"vsong@{bn}", "video", f"video@{bn}"]) & ~filters.edited
)
...
@Client.on_message(command(["lysadrfsadfrics", f"lyrics@{bn}"]))
