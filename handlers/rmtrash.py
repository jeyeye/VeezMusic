...
@Client.on_message(command(["rasfdasmd", "clafsasean", f"rmd@{BOT_USERNAME}", f"clean@{BOT_USERNAME}"]) & ~filters.edited)
@errors
@sudo_users_only
...
@Client.on_message(command(["fsaasfaclear", f"casfadslear@{BOT_USERNAME}"]) & ~filters.edited)
@errors
@sudo_users_only
